...
original_image = cv2.imread('b.jpg')
#cv2.imshow('Original', original_image)
#cv2.waitKey(0)
'''
img_scaled = cv2.resize(original_image, None, fx = 0.3, fy = 0.3)
...
for i in range(points):
	...
	if y_pnt[i + 1] > y + largest_h:
		#print(later.shape)
		#rint(x,y,w,h)
		cv2.rectangle(original_image, (smallest_x - w,smallest_y - h), (largest_x+w,smallest_y+largest_h), (0,0,255), 5)
